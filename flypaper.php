...
$sql="INSERT INTO STUDENT_TBL (STDNT_ID, ADULT_ID, STDNT_PSWD, SDNT_PMN, FNAME, LNAME, AGE, SCHOOL, GRADE, READLVL, READFREQ, READPURP, READENJ)
    VALUES ('".$q."', '".$r."', '".$s."', '".$t."', '".$u."', '".$v."', '".$w."', '".$x."', '".$y."', '".$z."', '".$a."', '".$b."', '".$c."')";
$result = mysqli_query($con,$sql);	
}
...
$sql="INSERT INTO ADULT_TBL (ADLT_ID, ADNAME, GROUP_ID, ADLT_PSWD, ADLT_PMN)
VALUES ('".$q."', '".$r."', '".$s."', '".$t."', '".$u."')";
$result = mysqli_query($con,$sql);	
}
