jQuery(function($) {
    ...
    var questionCount = 1;   //Keep track of the number of questions (also used in creating the id for each new question)
    var answerCount = 1;     //Keep track of the number of answers (also used in creating the id for each new answer)
