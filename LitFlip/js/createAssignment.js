jQuery(function($) {
    ...
    $(document).on ('click', '#createNewQuestion', function() {
        ...
        var newQuestion = $('<br><br> <div class="form-group addQuestion"> <label class="col-xs-4 col-xs-offset-1 col-lg-2 col-lg-offset-3 control-label" for="newQuestion">Create New Question:</label> <div class="col-xs-6 col-md-4 col-lg-3"> <input id="newquestion" name="newquestion" type="text" placeholder="Question" class="form-control input-md" required=""> </div> </div>');
        var answer = $('<div class="form-group addAnswer"> <label class="col-xs-4 col-xs-offset-1 col-lg-2 col-lg-offset-3 control-label" for="Answer">Answer:</label> <div class="col-xs-6 col-md-4 col-lg-3"> <input id="answer" name="answer" type="text" placeholder="Answer" class="form-control input-md" required=""> </div> </div>');
        var deleteQuestion = $('<br> <div class="form-group deleteQuestion"><label class="col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 col-lg-2 col-lg-offset-5" for="deleteQuestion"> <input class="btn btn-success deleteQuestionButton" type="button" name="deleteQuestion" id="deleteQuestion" value="Delete"> </label> </div>');
	...
	$(document).on('click', '.deleteQuestionButton', function() {
		...
		alert ("Deleting a question " + (this).attr('id'));
	});
